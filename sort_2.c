 ...
 void    ft_handle_compare_matrice_part_1(t_compare **comparator)
{
    ...
    {
        (*comparator)->compare_matrice[0][0] = *(int *)(*comparator)->first_a_card->content -
        *(int *)(*comparator)->first_b_card->content;
    }
    else 
        (*comparator)->compare_matrice[0][0] = INT_MAX;
    if ((*comparator)->second_a_card && (*comparator)->first_b_card)
    {
        (*comparator)->compare_matrice[0][1] = *(int *)(*comparator)->second_a_card->content -
        *(int *)(*comparator)->first_b_card->content;
    }
    else
    ...
    {
        (*comparator)->compare_matrice[0][2] = *(int *)(*comparator)->last_a_card->content -
        *(int *)(*comparator)->first_b_card->content;
    }
    else 
        (*comparator)->compare_matrice[0][1] = INT_MAX;
 ...
 void    ft_handle_compare_matrice_part_2(t_compare **comparator)
 {
    ...
    {
    (*comparator)->compare_matrice[1][0] = *(int *)(*comparator)->first_a_card->content -
    *(int *)(*comparator)->last_b_card->content;
    }
    else
        (*comparator)->compare_matrice[1][0] = INT_MAX;
    if (((*comparator)->second_a_card && (*comparator)->last_b_card))
        {
    (*comparator)->compare_matrice[1][1] = *(int *)(*comparator)->second_a_card->content -
    *(int *)(*comparator)->last_b_card->content;
        }
        else 
        ...
        if ((*comparator)->second_a_card && (*comparator)->last_b_card)
        {
            (*comparator)->compare_matrice[1][2] = *(int *)(*comparator)->last_a_card->content -
            *(int *)(*comparator)->last_b_card->content;
        }
        else
